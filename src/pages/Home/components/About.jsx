...
function About() {
  return (
    <div className="contentSection w-11/12 cmd:w-10/12 flex flex-col items-center cmd:flex-row cmd:gap-10 justify-center cmd:justify-between p-10 mx-auto ">
      ...
      <div className="w-full cmd:w-8/12  p-4 flex flex-col justify-center gap-5 ">
