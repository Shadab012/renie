...
const HeroSec4 = () => {
  return (
    <div className="renie-hub-track-main flex justify-center">
      <div className="max-w-[1440px] cmd:h-[650px] px-5 sm:px-6 lg:px-8 flex flex-col-reverse cmd:flex-row justify-center items-center gap-14 cmd:gap-0 py-14">
        <div className="w-full cmd:w-[50%]">
          <h2 className="text-[45px] leading-[35px] font-[900] gradient-text text-center cmd:text-left">
          ...
          <div className="flex justify-center cmd:justify-start">
