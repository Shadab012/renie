...
const HeroSec3 = () => {
  return (
    <div className=" renie-hub-transparency w-full text-center">
      ...
      >
        <h2 className="text-[36px] leading-[45px] font-[600] text-white ">
          How do I start earning with Renie?
        </h2>
      </div>
      <div className="mt-10 ">
        <h2 className="text-[36px] leading-[45px] font-[600] gradient-text text-center my-6 ">
          First, you’ll need full <br /> transparency and control
        </h2>
        <p className="max-w-[1209px] text-[18px] leading-[27px] font-[400] mx-auto py-4">
          {" "}
